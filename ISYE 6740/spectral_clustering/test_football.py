...
def read_team_name():
    ...
    f_path = abspath(
        "/Users/willbrennan/Desktop/Coding/school_repo/school_code/ISYE 6740/spectral_clustering/inverse_teams.txt"
    )
    idx2name = []
    if exists(f_path):
...
def import_graph():
    ...
    f_path = abspath(
        "/Users/willbrennan/Desktop/Coding/school_repo/school_code/ISYE 6740/spectral_clustering/play_graph.txt"
    )
    if exists(f_path):
