...
def run_game(
    mat, run_num, matrix_size, master_data_collection_dict, alive_percent, max_steps=101
):
    import numpy as np
...
def sample_runs(number_of_sample_per_matrix_size_and_percent_alive):
    from collections import defaultdict
    import pandas as pd
    import numpy as np
